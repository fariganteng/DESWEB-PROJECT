document.querySelector('button.submit').addEventListener('click', function() {
    ...
    var message = `Hello, Yulandha Store! I'm ${name}.%0A%0A${text}%0A%0ARegards, ${name}%0A%0A${email}`;
    var url = `https://api.whatsapp.com/send?phone=6282141109093&text=${message}`;
    window.open(url);
  });